"""
Django settings for ASLMachineLearning project.
...
SECRET_KEY = '1#%&p=9$tlgsej#qp-!9n$a3gr7$&x0apgc928@p$(8stqzeks'
...
ROOT_URLCONF = 'ASLMachineLearning.urls'
...
WSGI_APPLICATION = 'ASLMachineLearning.wsgi.application'
